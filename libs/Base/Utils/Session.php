...
class Session {
    ...
    public static function init() {
        if(SESSION_STORE === 'redis') $sessionHandler = new DRedisHandler(new PredisClient(REDIS_URI), SECRET_KEY);
        if(SESSION_STORE === 'files') $sessionHandler = new DFileHandler(SECRET_KEY);
